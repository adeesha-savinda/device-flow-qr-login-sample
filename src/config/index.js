const IDP_HOST = '<HOST> ex: localhost or 192.168.1.200 or example.com';
const IDP_PORT = '<PORT> default port for WSO2 IS is 9443';
...
export const CLIENT_ID = '< CLIENT_ID OF THE APPLICATION >';
